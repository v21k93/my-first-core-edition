...
enum TrinityStrings
{
	...
	//Vip List
	LANG_VIPLIST                         = 95,
    LANG_VIPLIST_HEADER                  = 96,
    LANG_VIPLIST_EMPTY                   = 97,
	
	//Player First Login String
	LANG_PLAYER_FIRST_LOGIN_STRING		= 98,

	//VIP Chat
	LANG_VIP_ANNOUNCE_COLOR				= 99,
...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
	...
	LANG_EVENT_CUSTOM					= 11002,
	LANG_EVENT_CUSTOM_PVP1					= 11003,
